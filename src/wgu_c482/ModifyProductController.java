...
import static wgu_c482.MainController.productToModifyIndex;
...
public class ModifyProductController implements Initializable {
    ...
    @FXML
    void handleClearSearchAddButton(ActionEvent event) {
        updatePartTableView();
        ModifyProductAddPartSearchField.setText("");
    }

    @FXML
    void handleClearSearchRemoveButton(ActionEvent event) {
        updateCurrentPartTableView();
        ModifyProductDeletePartSearchField.setText("");
    }

    @FXML
    void handleSearchPartAddButton(ActionEvent event) {
    ...
    @FXML
    void handleSearchPartDeleteButton(ActionEvent event) {
