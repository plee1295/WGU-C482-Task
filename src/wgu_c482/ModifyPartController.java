...
import static wgu_c482.MainController.partToModifyIndex;
...
public class ModifyPartController implements Initializable {
    ...
    @FXML
    void handleModifyPartsCancelButton(ActionEvent event) throws IOException {
    ...
    @FXML
    void handleModifyPartsSaveButton(ActionEvent event) throws IOException {
        ...
        try {
            ...
            if (exceptionMessage.length() > 0) {
                ...
                Parent modifyProductCancel = FXMLLoader.load(getClass().getResource("Main.fxml"));
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        if (part instanceof InHouse) {
            ModifyPartsDynField.setText(Integer.toString(((InHouse) getPartInventory().get(partIndex)).getPartMachineID()));
            DynModifyPartLabel.setText("Machine ID");
            ModifyPartsInHouseRadioButton.setSelected(true);

        } else {
            ModifyPartsDynField.setText(((Outsourced) getPartInventory().get(partIndex)).getPartCompanyName());
            DynModifyPartLabel.setText("Company Name");
